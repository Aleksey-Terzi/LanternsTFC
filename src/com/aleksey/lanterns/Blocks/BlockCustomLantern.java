package com.aleksey.lanterns.Blocks;
...
public class BlockCustomLantern extends Block
{
    ...
    {
        _topIcon = register.registerIcon("lanterns:LanternTop" + _info.LanternName);
        _sideIcon = register.registerIcon("lanterns:LanternSide" + _info.LanternName);
    }
}
